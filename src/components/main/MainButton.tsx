...
const MainButton = ({ style, openConnectModal,tomo_conneted }: { style?: React.CSSProperties; openConnectModal?: any;tomo_conneted?:boolean }) => {
    ...
    <>
      ...
      {connected||tomo_conneted ? (
        <TonWalletWrapper
          ...
          $connected={connected||tomo_conneted}
        >
