...
const TokenFilter = () => {
  ...
  const CustomIcon = ({ isOpen }: { isOpen: boolean }) => (
    <img src={isOpen ? IcArrowUp : IcArrowDown} alt="toggle icon" style={{ width: '14px', height: '14px',marginRight:"10px" }} />
  );
  ...
  return (
    <div>
      <FormControl>
        ...
        style={{ backgroundColor: "#1A1B23",borderRadius:"20px",height:"35px",width:selectWidth,display:"flex",textAlign:"start",outline:"none",border:"none"}}
