import 'zustand';
import { Q as useProxyLocalStorage, _ as _asyncToGenerator, a as _regeneratorRuntime, q as _extends, x as getTonBalance } from './EthereumProvider-0d47aac9.js';
import 'axios';
...
import { useTonConnectUI, useTonConnectModal } from './index-75026a6b.js';
...
var useTonConnect = function useTonConnect(option) {
  ...
  var _useTonConnectUI = useTonConnectUI(),
    tonConnectUI = _useTonConnectUI[0];
  var _useTonConnectModal = useTonConnectModal(),
    open = _useTonConnectModal.open;
  var storage = useProxyLocalStorage();
  var connect = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(connectParams) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            storage.set('accounts', _extends({}, storage.get('accounts') || {}, {
              ton: undefined
            }));
          ...
          var _value = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  return _context3.abrupt("return", getTonBalance({
...
//# sourceMappingURL=TonConnect-41c89705.js.map
