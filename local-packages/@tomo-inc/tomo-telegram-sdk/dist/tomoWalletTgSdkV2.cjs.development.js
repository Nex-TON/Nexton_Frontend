...
var TonWeb = _interopDefault(require('tonweb'));
require('viem');
...
var BasicProvider = /*#__PURE__*/function (_EventEmitter) {
  function BasicProvider(options) {
    ...
    _this.utils = new tomoEvmProvider.ProviderUtils(tomoEvmProvider._extends({}, tomoEvmProvider.BASE_URL, options));
    _this.isConnected = false;
    return _this;
  }
  tomoEvmProvider._inheritsLoose(BasicProvider, _EventEmitter);
  var _proto = BasicProvider.prototype;
  _proto.connect = /*#__PURE__*/function () {
    var _connect = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee(method, params) {
  ...
  _proto.disconnect = /*#__PURE__*/function () {
    var _disconnect = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee2(method) {
...
var SolanaProvider = /*#__PURE__*/function (_BasicProvider) {
  function SolanaProvider(options) {
    ...
    _this.isConnected = false;
    _this.chainId = tomoEvmProvider.mockSolEvmChainId;
    _this.isConnected = false;
    _this._initialize();
    return _this;
  }
  tomoEvmProvider._inheritsLoose(SolanaProvider, _BasicProvider);
  ...
  _proto.connectWallet = /*#__PURE__*/function () {
    var _connectWallet = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee(params) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
  ...
  _proto.disconnectWallet = /*#__PURE__*/function () {
    var _disconnectWallet = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee2() {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
  ...
  _proto.sendTransaction = /*#__PURE__*/function () {
    var _sendTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee3(tx) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return tomoEvmProvider.sendTransaction$1(tx);
          case 2:
            res = _context3.sent;
  ...
  _proto.getBalance = /*#__PURE__*/function () {
    var _getBalance = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee4(address) {
      var _this$account;
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee4$(_context4) {
  ...
  _proto.signMessage = /*#__PURE__*/function () {
    var _signMessage = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee5(message) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee5$(_context5) {
  ...
  _proto.signTransaction = /*#__PURE__*/function () {
    var _signTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee6(tx) {
      var txHex, res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee6$(_context6) {
  ...
  _proto.transfer = /*#__PURE__*/function () {
    var _transfer = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee7(params) {
      var param, res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            param = {
              method: 'sol_signTransaction',
              params: [tomoEvmProvider._extends({}, params, {
                chainId: this.chainId
              })]
            };
            _context7.next = 3;
  ...
  _proto.transferToken = /*#__PURE__*/function () {
    var _transferToken = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee8(params) {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee8$(_context8) {
  ...
  /*#__PURE__*/
  function () {
    var _disconnect = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee9() {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee9$(_context9) {
...
function parsingTonTxPayload(payloadHex) {
  var cell = core.Cell.fromBase64(hexToBase64(payloadHex));
...
function _checkIsJettonWallet() {
  _checkIsJettonWallet = tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee(jettonWalletAddress) {
...
var TonProvider = /*#__PURE__*/function (_BasicProvider) {
  function TonProvider(options) {
    var _this;
    _this = _BasicProvider.call(this, options) || this;
    _this.chainId = tomoEvmProvider.mockTonChainId;
    _this.isConnected = false;
    _this._initialize();
    return _this;
  }
  tomoEvmProvider._inheritsLoose(TonProvider, _BasicProvider);
  ...
  _proto._initialize = function _initialize() {
    ...
    if (account) {
      this.account = account;
      this.isConnected = true;
      this.chainId = account.chainId || tomoEvmProvider.mockTonChainId;
    }
  }
  ...
  /*#__PURE__*/
  function () {
    var _connect = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee(params) {
      var _params$workChain, res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            if ((params == null ? void 0 : params.network) === 'testnet') {
              this.chainId = tomoEvmProvider.mockTonTestnetChainId;
              params.chainId = tomoEvmProvider.mockTonTestnetChainId;
            }
            if (params != null && params.tonProof) {
              ...
              params.chainId = tomoEvmProvider.mockTonChainId;
            }
            _context.next = 4;
  ...
  _proto.restoreConnection = /*#__PURE__*/function () {
    var _restoreConnection = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee2() {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
  ...
  _proto.getBalance = /*#__PURE__*/function () {
    var _getBalance = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee3(address) {
      var _this$account2;
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
  ...
  _proto.signTransaction = /*#__PURE__*/function () {
    var _signTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee4(txs) {
      var _this2 = this;
      var newTxs, res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
  ...
  _proto.signTx = /*#__PURE__*/function () {
    var _signTx = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee5(txs) {
      var _this3 = this;
      var newTxs, res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
  ...
  _proto.sendTransaction = /*#__PURE__*/function () {
    var _sendTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee6(params) {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
  ...
  _proto.sendTx = /*#__PURE__*/function () {
    var _sendTx = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee7(params) {
      ...
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 11:
            ...
            _context7.next = 14;
            return tomoEvmProvider.sendTransaction(signRes.result, '', this.chainId);
          case 14:
            res = _context7.sent;
  ...
  _proto.checkValue = function checkValue(param) {
    try {
      core.fromNano(param.body.messages[0].amount);
    } catch (e) {
  ...
  _proto.parsePayloadAsJSON = function parsePayloadAsJSON(body, payload) {
    ...
    return tomoEvmProvider._extends({}, body, {
      contractAddress: contractAddr,
      precision: precision,
      forwardAmount: forwardAmount,
      memo: memo,
      type: tomoEvmProvider.TonTxBodyType.JETTON_PAYLOAD_JSON_LEGACY
    });
  };
  _proto.parsePayloadAsStandard = /*#__PURE__*/function () {
    var _parsePayloadAsStandard = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee8(tonTx) {
      ...
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            result = {
              type: tomoEvmProvider.TonTxBodyType.STANDARD,
              body: tonTx
            };
            if (payload) {
              _context8.next = 4;
  ...
  return tomoEvmProvider._createClass(TonProvider, [{
    key: "connected",
    get: function get() {
...
var suiClient = /*#__PURE__*/new client.SuiClient({
  url: suiEndPoint
});
var sendSuiTx = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee(_ref) {
...
var SuiProvider = /*#__PURE__*/function (_BasicProvider) {
  ...
  tomoEvmProvider._inheritsLoose(SuiProvider, _BasicProvider);
  ...
  _proto.sendTransaction = /*#__PURE__*/function () {
    var _sendTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee3(p) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
  ...
  /*#__PURE__*/
  function () {
    var _signMessage = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee4(message) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
  ...
  /*#__PURE__*/
  function () {
    var _signPersonalMessage = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee5(message) {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
  ...
  _proto.signTransaction = /*#__PURE__*/function () {
    var _signTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee6(params) {
      var res;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
  ...
  _proto.signAndExecuteTransaction = /*#__PURE__*/function () {
    var _signAndExecuteTransaction = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee7(params) {
      var tx;
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
  ...
  _proto.disconnect = /*#__PURE__*/function () {
    var _disconnect = /*#__PURE__*/tomoEvmProvider._asyncToGenerator(/*#__PURE__*/tomoEvmProvider._regeneratorRuntime().mark(function _callee8() {
      return tomoEvmProvider._regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            this.account = null;
...
var WalletTgSdk = /*#__PURE__*/function (_Eventemitter) {
  function WalletTgSdk(options) {
    var _this;
    _this = _Eventemitter.call(this) || this;
    _this.version = tomoEvmProvider.AppInfo.version;
    _this.getAppInfo = function () {
      return tomoEvmProvider._extends({}, tomoEvmProvider.AppInfo);
    };
    var metaData = options == null ? void 0 : options.metaData;
    _this.connectUrl = (options == null ? void 0 : options.connect) || tomoEvmProvider.BASE_URL.connect;
    _this.bridgeUrl = (options == null ? void 0 : options.bridge) || tomoEvmProvider.BASE_URL.bridge;
    _this.connect_direct_link = (options == null ? void 0 : options.connect_direct_link) || tomoEvmProvider.BASE_URL.connect_direct_link;
  ...
  tomoEvmProvider._inheritsLoose(WalletTgSdk, _Eventemitter);
  var _proto = WalletTgSdk.prototype;
  _proto._initialize = function _initialize() {
    //initialize provider
    this.ethereum = new tomoEvmProvider.EthereumProvider({
...
exports.default = WalletTgSdk;
//# sourceMappingURL=tomoWalletTgSdkV2.cjs.development.js.map
