...
var reactTelegramWebApp = require('@vkruglikov/react-telegram-web-app');
var create = require('zustand');
var create__default = _interopDefault(create);
...
var core$1 = require('@wagmi/core');
var wagmi = require('wagmi');
var chains = require('viem/chains');
var ReactDOM = _interopDefault(require('react-dom'));
require('qs');
require('uuid');
var okxConnect_error = require('@okxconnect/core/src/protocol/error/okx-connect.error');
var omniConnect = require('@bitget-wallet/omni-connect');
require('eventemitter3');
require('buffer');
var tomoWalletTgSdkV2 = require('./tomoWalletTgSdkV2.cjs.development.js');
...
var useStore = /*#__PURE__*/ create__default(function (set) {
  return {
    bioAvailable: false,
    bioInited: false,
...
function useBiometricManager() {
  ...
  var WebApp = reactTelegramWebApp.useWebApp();
...
function usePaymentPasswd() {
  ...
  var setPasswd = /*#__PURE__*/ (function () {
    var _ref = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee(passwd) {
          var res;
          return tomoEvmProvider._regeneratorRuntime().wrap(
              ...
              while (1)
                switch ((_context.prev = _context.next)) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return tomoEvmProvider.setPaymentPasswd({
                      passwd: passwd,
                    });
                  case 3:
                    res = _context.sent;
                    if (!(res.code === tomoEvmProvider.successCode)) {
                      _context.next = 6;
                      break;
                    }
  ...
  var changePasswd = /*#__PURE__*/ (function () {
    var _ref2 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee2(old_passwd, new_passwd) {
              ...
              while (1)
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    _context2.prev = 0;
                    _context2.next = 3;
                    return tomoEvmProvider.changePaymentPasswd({
                  ...
                  case 3:
                    ...
                    if (!(code === tomoEvmProvider.successCode)) {
                      _context2.next = 8;
                      break;
                    }
  ...
  var validatePasswd = /*#__PURE__*/ (function () {
    var _ref3 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee3(passwd) {
              ...
              while (1)
                switch ((_context3.prev = _context3.next)) {
                  case 0:
                    _context3.prev = 0;
                    _context3.next = 3;
                    return tomoEvmProvider.validatePaymentPasswd({
                      passwd: passwd,
                    });
                  case 3:
  ...
  var checkPasswd = /*#__PURE__*/ (function () {
    var _ref4 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
              ...
              while (1)
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    _context4.prev = 0;
                    _context4.next = 3;
                    return tomoEvmProvider.checkPaymentPasswd();
                  case 3:
...
var setPassKey = function setPassKey(key) {
  try {
    localStorage.setItem(tomoEvmProvider.passkeyKey, key);
  } catch (e) {
    // do something
  }
};
...
function _hashWithWebCrypto() {
  _hashWithWebCrypto = tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
      .mark(function _callee(message) {
        var msgBuffer, hashBuffer, hashArray, hashHex;
        return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(
          _context
        ) {
          while (1)
            switch ((_context.prev = _context.next)) {
...
function _sleep() {
  _sleep = tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
      .mark(function _callee2(ms) {
        return tomoEvmProvider._regeneratorRuntime().wrap(function _callee2$(
          _context2
        ) {
          while (1)
            switch ((_context2.prev = _context2.next)) {
...
var useMFAVerify = function useMFAVerify() {
  ...
  var deviceId = tomoEvmProvider.getDeviceId();
  var _usePaymentPasswd = usePaymentPasswd();
  var signMessage = /*#__PURE__*/ (function () {
    var _ref = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee(params, device_no, type) {
            ...
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  _context.next = 4;
                  return tomoEvmProvider.pkSignApi({
                    message: message,
                    device_no: device_no,
                  });
                case 4:
                ...
                case 7:
                  if (!(signRes.code != tomoEvmProvider.successCode)) {
                    _context.next = 9;
                    break;
                  }
                ...
                case 9:
                  _context.next = 11;
                  return tomoEvmProvider.pkValidateApi({
                    device_no: device_no,
                    message: message,
                ...
                case 14:
                  if (!(valRes.code != tomoEvmProvider.successCode)) {
                    _context.next = 16;
                    break;
                  }
  ...
  var getMFAParams = /*#__PURE__*/ (function () {
    var _ref2 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider._regeneratorRuntime().mark(
        function _callee5(
          params,
          type,
          ...
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee5$(
            _context5
          ) {
            while (1)
                        ...
                        var _ref3 = tomoEvmProvider._asyncToGenerator(
                          /*#__PURE__*/ tomoEvmProvider
                            ...
                            .mark(function _callee4(resolve, reject) {
                              return tomoEvmProvider
                                ._regeneratorRuntime()
                                .wrap(function _callee4$(_context4) {
                                  while (1)
                                    switch ((_context4.prev = _context4.next)) {
                                      case 0:
                                        if (!(type == 'password')) {
                                        ...
                                        _context4.next = 3;
                                        return tomoEvmProvider._asyncToGenerator(
                                          /*#__PURE__*/ tomoEvmProvider
                                            ._regeneratorRuntime()
                                                ...
                                                .wrap(function _callee2$(
                                                  ...
                                                  while (1)
                                                    switch (
                                                      ...
                                                      case 0:
                                                        _context2.t0 =
                                                          tomoEvmProvider.mfaAuthVerificationApi;
                                                        _context2.next = 3;
                                      ...
                                      case 4:
                                        ...
                                        try {
                                          ...
                                          biometricManager.authenticate({
                                            ...
                                            callback: (function () {
                                              var _callback =
                                                tomoEvmProvider._asyncToGenerator(
                                                  /*#__PURE__*/ tomoEvmProvider
                                                    ._regeneratorRuntime()
                                                    .mark(
                                                      function _callee3(
...
var getChainId = function getChainId(chain) {
  ...
  if ((chain == null ? void 0 : chain.type) === Web3Type.SOL) {
    return tomoEvmProvider.mockSolEvmChainId;
  }
  if ((chain == null ? void 0 : chain.type) === Web3Type.BTC) {
    return tomoEvmProvider.mockBtcEvmChainId;
  }
  if ((chain == null ? void 0 : chain.type) === Web3Type.TON) {
    return tomoEvmProvider.mockTonChainId;
  }
...
var useChainConfig = function useChainConfig() {
  return reactQuery.useQuery({
    ...
    queryFn: tomoEvmProvider.getConfigChainsAll,
  });
};
...
var useChains = function useChains() {
  ...
  var getChain = function getChain(chainId) {
    if (chainId === tomoEvmProvider.mockSolEvmChainId) {
      return chainInfo$1;
    }
    if (chainId === tomoEvmProvider.mockBtcEvmChainId) {
      return chainInfo;
    }
    if (chainId === tomoEvmProvider.mockTonChainId) {
      return chainInfo$2;
    }
...
function useTomoUserInfo() {
  var _useLocalStore = tomoEvmProvider.useLocalStore(),
  ...
  return {
    ...
    generateDeviceId: (function () {
      var _generateDeviceId = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
              ...
              while (1)
                switch ((_context.prev = _context.next)) {
                  ...
                  case 2:
                    ...
                    //generate pubkey
                    _context.next = 7;
                    return tomoEvmProvider.pkRegApi(id);
                  case 7:
                    v2PkRegRes = _context.sent;
                    if (!(v2PkRegRes.code != tomoEvmProvider.successCode)) {
                      _context.next = 10;
                      break;
                    }
                  ...
                  case 10:
                    ...
                    _context.next = 13;
                    return tomoEvmProvider.pkCreateApi({
                      device_no: id,
                      pubkey: pubkey,
                    });
                  case 13:
                    v2PkCreateRes = _context.sent;
                    if (!(v2PkCreateRes.code != tomoEvmProvider.successCode)) {
                      _context.next = 16;
                      break;
                    }
                  ...
                  case 16:
                    _context.next = 18;
                    return tomoEvmProvider.pkCheckApi(id);
                  case 18:
                    checkRes = _context.sent;
                    if (!(checkRes.code != tomoEvmProvider.successCode)) {
                      _context.next = 21;
                      break;
                    }
...
var useConfig = function useConfig() {
  ...
  var _evmChains = evmChains
    ...
    .map(function (m) {
      if (m.id == 1) {
        return tomoEvmProvider._extends({}, m, {
          rpcUrls: {
            default: {
...
var getBalanceFromNode = /*#__PURE__*/ (function () {
  var _ref = /*#__PURE__*/ tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
      .mark(function _callee(address, rpc) {
        var res;
        return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(
          _context
        ) {
...
var useBTCBalance = function useBTCBalance(netWorkType) {
  ...
  var getByAddressBalance = /*#__PURE__*/ (function () {
    var _ref2 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee2(address) {
          var rpc, btcRes;
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee2$(
            _context2
          ) {
  ...
  return reactQuery.useQuery({
    ...
    queryFn: (function () {
      var _queryFn = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
          .mark(function _callee4() {
            var data;
                ...
                while (1)
                  switch ((_context4.prev = _context4.next)) {
                    case 0:
                      ...
                      _context4.next = 3;
                      return Promise.all(
                        tomoEvmProvider.btcAddressTypeMaps.map(
                          /*#__PURE__*/ (function () {
                            var _ref3 = tomoEvmProvider._asyncToGenerator(
                              /*#__PURE__*/ tomoEvmProvider
                                ._regeneratorRuntime()
                                .mark(function _callee3(typeKey) {
                                  var address, value;
                                  return tomoEvmProvider
                                    ._regeneratorRuntime()
                                    .wrap(function _callee3$(_context3) {
                                      while (1)
                                        switch (
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      connection = tomoEvmProvider.getConnection();
                      _context.next = 5;
                      return new Promise(function (resolve) {
                        resolve(_interopNamespace(require('@solana/web3.js')));
                      });
                    case 5:
...
var useBalance = function useBalance(_ref, options) {
  ...
  var balance = reactQuery.useQuery({
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      value =
                        (_btcBalanceQuery$data =
                          (_btcBalanceQuery$data2 = btcBalanceQuery.data) ==
                          null
                            ? void 0
                            : _btcBalanceQuery$data2.reduce(function (
                                acc,
                                item
                              ) {
                          ...
                          : 0;
                      _balance = {
                        decimals: tomoEvmProvider.btcDecimals,
                        formatted: viem.formatUnits(
                          BigInt(value),
                          tomoEvmProvider.btcDecimals
                        ),
                        symbol: 'BTC',
                        value: BigInt(value),
                      };
                    ...
                    case 7:
                      ...
                      _context.next = 11;
                      return tomoEvmProvider.getSolBalance({
                        address: solAddress,
                        token: token,
                      });
                    case 11:
                      ...
                      _balance2 = {
                        decimals: decimals,
                        formatted: decimals
                          ? viem.formatUnits(_value, decimals)
                          : '0',
                    ...
                    case 18:
                      ...
                      return _context.abrupt('return', {
                        decimals: tomoEvmProvider.solDecimals,
                        formatted: viem.formatUnits(
                          _value2,
                          tomoEvmProvider.solDecimals
                        ),
                        symbol: 'SOL',
                        value: _value2,
                      });
                    ...
                    case 23:
                      ...
                      _context.next = 26;
                      return core$1.getBalance(config, {
                        address: evmAddress,
                        chainId: chainId,
                        token: token,
                      });
                    ...
                    case 30:
                      ...
                      _context.next = 33;
                      return tomoEvmProvider.getTonBalance({
                        tonAddress: tonAddress,
                    ...
                    case 33:
                      ...
                      return _context.abrupt('return', {
                        decimals: token ? decimal : tomoEvmProvider.tonDecimals,
...
var useUserTokens = function useUserTokens(tokenSize, options) {
  ...
  var _useTomoUserInfo = useTomoUserInfo(),
    evmAddress = _useTomoUserInfo.evmAddress,
    solAddress = _useTomoUserInfo.solAddress;
  var systemTokensQuery = reactQuery.useQuery({
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return tomoEvmProvider.getSystemTokens({
  ...
  var userCustomTokensQuery = reactQuery.useQuery({
    queryKey: ['userCustomTokens', evmAddress, solAddress],
    queryFn: (function () {
      var _queryFn2 = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
          .mark(function _callee2() {
            return tomoEvmProvider._regeneratorRuntime().wrap(
                ...
                while (1)
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      _context2.prev = 0;
                      _context2.next = 3;
                      return tomoEvmProvider.v1AllAssetApi({
                        page: 1,
                        pageSize: tokenSize,
                      });
                    case 3:
    ...
    var _ref = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ...
        .mark(function _callee3(params) {
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee3$(
            _context3
          ) {
            while (1)
              switch ((_context3.prev = _context3.next)) {
                case 0:
                  _context3.next = 2;
                  return tomoEvmProvider.v1AddAssetApi(params);
                case 2:
...
var useSendTransaction = function useSendTransaction(options) {
  ...
  var connect = tomoEvmProvider.getConnection();
  var _useChains = useChains(),
              ...
              while (1)
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    ...
                    _context2.next = 7;
                    return core$1.getGasPrice(params.config, {
                      chainId: chainId,
                    });
                  case 7:
                    gasPrice = _context2.sent;
                    _context2.next = 10;
                    return core$1.prepareTransactionRequest(params.config, {
                      chainId: chainId,
                  ...
                  case 10:
                    ...
                    mfaParams = {
                      ...
                      maxPriorityFeePerGas:
                        (_res$maxPriorityFeePe = res.maxPriorityFeePerGas) ==
                        null
                          ? void 0
                  ...
                  case 26:
                    _context2.next = 28;
                    return tomoEvmProvider.signEvmTransactionApi(mfa, {
                  ...
                  case 28:
                    ...
                    publicClient = core$1.getPublicClient(params.config); // @ts-ignore
                    _context2.next = 32;
                  ...
                  case 32:
                    ...
                    return setCustomToken(
                      tomoEvmProvider._extends({}, params.toToken, {
              ...
              while (1)
                switch ((_context4.prev = _context4.next)) {
                  case 0:
                    ...
                    _context4.next = 5;
                    return tomoEvmProvider.ToSerializeTransaction(params.data);
                  case 5:
                  ...
                  case 8:
                    ...
                    _context4.next = 11;
                    return tomoEvmProvider.sendSolTx(
                      params.fromAddress,
                      // my Address
                      params.toAddress,
                      // toAddress
                  ...
                  case 14:
                    _context4.next = 16;
                    return tomoEvmProvider.getSendSplToken(
                      params.contract,
                      params.fromAddress,
                      params.toAddress,
                      params.value
                  ...
                  case 17:
                    ...
                    return getMFAParams(
                      {
                        data: txStr,
                        chainid: tomoEvmProvider.mockSolEvmChainId,
                      },
                      params.mfaType,
                      params.password
                    );
                  case 19:
                    ...
                    _context4.next = 24;
                    return tomoEvmProvider.solSignRawTransaction({
                                    ...
                                    case 21:
                                      historySave = {
                                        ...
                                        historyType: params.historyType
                                          ...
                                          : 'Send',
                                        chainId:
                                          tomoEvmProvider.mockSolEvmChainId,
                                      };
                                      if (!(params.historyType === 'Swap')) {
                                        _context3.next = 26;
                                        break;
              ...
              while (1)
                switch ((_context5.prev = _context5.next)) {
                  case 0:
                    _context5.prev = 0;
                    amount = viem
                      .parseUnits(params.value, tomoEvmProvider.btcDecimals)
                      .toString();
                    _context5.next = 4;
                    return tomoEvmProvider.sendTx({
                  ...
                  case 7:
                    ...
                    setPassKey(mfaRes.mfa);
                    _context5.next = 12;
                    return tomoEvmProvider.btcSignPsbtAndPush({
                  ...
                  case 12:
                    ...
                    historySave = {
                      ...
                      historyType: params.historyType
                        ? params.historyType
                        : 'Send',
                      chainId: tomoEvmProvider.mockBtcEvmChainId,
                    };
                    if (!(params.historyType === 'Swap')) {
                      _context5.next = 20;
                      break;
  ...
  var sendTonTransaction = /*#__PURE__*/ (function () {
    var _ref5 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
              ...
              while (1)
                switch ((_context6.prev = _context6.next)) {
                  case 0:
                    _context6.prev = 0;
                    _context6.next = 3;
                    return tomoEvmProvider.createSigningTransaction(params);
                  case 3:
                  ...
                  case 6:
                    ...
                    return getMFAParams(
                      {
                        data: singingMessage,
                        chainid: tomoEvmProvider.mockTonChainId,
                      },
                      params.mfaType,
                      params.password
                    );
                  ...
                  case 12:
                    ...
                    _context6.next = 16;
                    return tomoEvmProvider.tonSignMessage(mfa, mfaParams);
                  case 16:
                  ...
                  case 22:
                    _context6.next = 24;
                    return tomoEvmProvider.sendTransaction(
                      signedTransaction,
                      params.fromAddress
                    );
                  case 24:
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      _context.prev = 0;
                      _context.next = 3;
                      return tomoEvmProvider.getSwapAllTokensV3({
                        chain: chain,
                      });
                    case 3:
                      return _context.abrupt('return', _context.sent);
                ...
                while (1)
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      _context2.prev = 0;
                      _context2.next = 3;
                      return tomoEvmProvider.getSwapAllTokensSearch(
                        {
                          content: content,
                          chain: chain,
                        },
...
var findSwapChainName = function findSwapChainName(chainId) {
  switch (chainId) {
    ...
    case chains.optimism.id:
      return 'OPTIMISM';
    case chains.base == null ? void 0 : chains.base.id:
      return 'BASE';
    ...
    case chains.b3.id:
      return 'B3';
    case tomoEvmProvider.mockBtcEvmChainId:
      return 'BITCOIN';
    case tomoEvmProvider.mockSolEvmChainId:
      return 'SOLANA';
    default:
      return '';
  }
...
//@ts-nocheck
var queryClient = /*#__PURE__*/ new reactQuery.QueryClient();
...
var SvgOkxWallet = function SvgOkxWallet(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect ||
      (_rect = /*#__PURE__*/ React.createElement('rect', {
        width: 48,
        height: 48,
        x: 0.667,
        fill: '#131618',
    ...
    _rect2 ||
      (_rect2 = /*#__PURE__*/ React.createElement('rect', {
        width: 47.5,
        height: 47.5,
        x: 0.917,
        y: 0.25,
...
var SvgTon2 = function SvgTon2(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect$1 ||
      (_rect$1 = /*#__PURE__*/ React.createElement('rect', {
        width: 19,
        height: 19,
        x: 0.5,
        y: 0.5,
    ...
    _defs ||
      (_defs = /*#__PURE__*/ React.createElement(
        'defs',
        null,
...
var SvgTonkeeper = function SvgTonkeeper(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect$2 ||
      (_rect$2 = /*#__PURE__*/ React.createElement('rect', {
        width: 20,
        height: 20,
    ...
    _defs$1 ||
      (_defs$1 = /*#__PURE__*/ React.createElement(
        'defs',
        null,
        /*#__PURE__*/ React.createElement(
          'pattern',
...
var SvgTon3 = function SvgTon3(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect$3 ||
      (_rect$3 = /*#__PURE__*/ React.createElement('rect', {
        width: 20,
        height: 20,
    ...
    _defs$2 ||
      (_defs$2 = /*#__PURE__*/ React.createElement(
        'defs',
        null,
        /*#__PURE__*/ React.createElement(
          'pattern',
...
var SvgTon4 = function SvgTon4(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect$4 ||
      (_rect$4 = /*#__PURE__*/ React.createElement('rect', {
        width: 20,
        height: 20,
    ...
    _defs$3 ||
      (_defs$3 = /*#__PURE__*/ React.createElement(
        'defs',
        null,
        /*#__PURE__*/ React.createElement(
          'pattern',
...
var SvgTomo = function SvgTomo(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _path4 ||
      (_path4 = /*#__PURE__*/ React.createElement('path', {
        fill: '#627EEA',
        stroke: '#fff',
        strokeWidth: 1.4,
    ...
    _path5 ||
      (_path5 = /*#__PURE__*/ React.createElement('path', {
        fill: '#fff',
    ...
    _g ||
      (_g = /*#__PURE__*/ React.createElement(
        'g',
        {
    ...
    _defs$4 ||
      (_defs$4 = /*#__PURE__*/ React.createElement(
        'defs',
        null,
        /*#__PURE__*/ React.createElement(
          'radialGradient',
...
var SvgIconTg = function SvgIconTg(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _rect$5 ||
      (_rect$5 = /*#__PURE__*/ React.createElement('rect', {
        width: 22,
        height: 22,
        fill: '#fff',
        rx: 4,
    ...
    _g$1 ||
      (_g$1 = /*#__PURE__*/ React.createElement(
        'g',
        {
    ...
    _defs$5 ||
      (_defs$5 = /*#__PURE__*/ React.createElement(
        'defs',
        null,
        /*#__PURE__*/ React.createElement(
          'linearGradient',
...
var SvgUxuy = function SvgUxuy(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    _g$2 ||
      (_g$2 = /*#__PURE__*/ React.createElement(
        'g',
        {
          fill: '#fff',
          fillRule: 'evenodd',
...
var useOkxTonConnect = function useOkxTonConnect(option) {
  ...
  var okxConnectRef = React.useRef(null);
  var _useState = React.useState(false),
    connected = _useState[0],
    setConnected = _useState[1];
  var showPopup = reactTelegramWebApp.useShowPopup();
  var _useInitData = reactTelegramWebApp.useInitData(),
        ...
        .mark(function _callee() {
          ...
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(
            ...
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  language = tomoEvmProvider.getOkxLanguage(
                    initDataUnsafe == null ||
                ...
                case 6:
                  _context.next = 8;
                  return new Promise(function (resolve) {
                    resolve(_interopNamespace(require('@okxconnect/ui')));
                  });
                case 8:
              ...
              switch ((_context3.prev = _context3.next)) {
                ...
                case 3:
                  ...
                  Object.defineProperty(okxTonConnect, 'getBalance', {
                    value: (function () {
                      var _value = tomoEvmProvider._asyncToGenerator(
                        /*#__PURE__*/ tomoEvmProvider
                          ._regeneratorRuntime()
                          .mark(function _callee2() {
                            return tomoEvmProvider
  ...
  var handleDisconnected = function handleDisconnected() {
    ...
    storage.set(
      'accounts',
      tomoEvmProvider._extends({}, storage.get('accounts') || {}, {
        ton: undefined,
      })
    );
  ...
  var listenStatusChange = function listenStatusChange() {
    ...
    var unsubscribe = okxTonConnect.onStatusChange(
      ...
      function (err) {
        if (
          err.code ===
          okxConnect_error.OKX_CONNECT_ERROR_CODES.USER_REJECTS_ERROR
        ) {
  ...
  var connect = /*#__PURE__*/ (function () {
    var _ref4 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee4(connectOption) {
          var okxTonConnect;
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee4$(
            _context4
          ) {
            while (1)
              switch ((_context4.prev = _context4.next)) {
              ...
              while (1)
                switch ((_context5.prev = _context5.next)) {
                  ...
                  case 9:
                    ...
                    if (
                      !(
                        _context5.t0 instanceof okxConnect_error.OKXConnectError
                      )
                    ) {
                      _context5.next = 21;
                      break;
                    ...
                    _context5.next =
                      _context5.t1 ===
                      okxConnect_error.OKX_CONNECT_ERROR_CODES
                        .NOT_CONNECTED_ERROR
                        ? 15
                        : 17;
                    break;
  ...
  var sendTransaction = /*#__PURE__*/ (function () {
    var _ref6 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee6(transactionRequest) {
              ...
              while (1)
                switch ((_context6.prev = _context6.next)) {
                  ...
                  case 11:
                    ...
                    if (
                      !(
                        _context6.t0 instanceof okxConnect_error.OKXConnectError
                      )
                    ) {
                      _context6.next = 25;
                      break;
...
var useOkxEVMConnect = function useOkxEVMConnect(option) {
  ...
  var _useInitData = reactTelegramWebApp.useInitData(),
    initDataUnsafe = _useInitData[0];
  var _useContext = React.useContext(TomoContext),
  ...
  var disconnectEffect = React.useCallback(
    function (input) {
...
function _getBitGetProvider() {
  _getBitGetProvider = tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
          ...
          while (1)
            switch ((_context4.prev = _context4.next)) {
              ...
              case 3:
                ...
                return new Promise(function (resolve) {
                  resolve(
                    _interopNamespace(require('@bitget-wallet/omni-connect'))
                  );
                });
              case 5:
                ...
                subscription = bitGetConnector.provider.onStatusChange(
                  function (walletInfo) {
                    ...
                    switch (event) {
                      case omniConnect.RequestMethods.Connect:
                        return onConnect == null ? void 0 : onConnect();
                      case omniConnect.RequestMethods.Disconnect:
                ...
                bitgetProvider = proxifyBitgetProvider(
                  bitGetConnector.provider
                );
                return _context4.abrupt('return', bitgetProvider);
              case 11:
              case 'end':
...
function useBitget(option) {
  ...
  function connectEffect(provider) {
    ...
    var storage = new tomoEvmProvider.ProxyLocalStorage();
    var type = 'BITGET';
  ...
  var initializeProvider = React.useCallback(
    /*#__PURE__*/ tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee() {
          var provider;
        ...
        initializeProvider().then(
          /*#__PURE__*/ (function () {
            var _ref3 = tomoEvmProvider._asyncToGenerator(
              /*#__PURE__*/ tomoEvmProvider
                ._regeneratorRuntime()
                .mark(function _callee2(provider) {
                  return tomoEvmProvider
                    ._regeneratorRuntime()
                    .wrap(function _callee2$(_context2) {
                      while (1)
...
var useTomoConnect = function useTomoConnect(_ref) {
  ...
  var connect = /*#__PURE__*/ (function () {
    var _ref2 = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee(connectOptions) {
          var providers,
            _ref3,
            email,
            tonProof,
              ...
              while (1)
                switch ((_context.prev = _context.next)) {
                  case 0:
                    ...
                    providers = new tomoWalletTgSdkV2.default(
                      tomoEvmProvider._extends(
                        {
                          injected: true,
                        },
    ...
    function () {
      ...
      if (connectType === 'TOMO') {
        ...
        if (chain === 'EVM' && !providers.ethereum) {
          ...
          var evmProvider = new tomoEvmProvider.EthereumProvider(
            tomoEvmProvider._extends(
              {
                injected: true,
              },
        ...
        if (chain === 'TON' && !providers.tomo_ton) {
          // todo
          var _providers = new tomoWalletTgSdkV2.default(
            tomoEvmProvider._extends(
              {
                injected: true,
              },
        ...
        if (chain === 'SOL' && !providers.tomo_sol) {
          var _providers2 = new tomoWalletTgSdkV2.default(
            tomoEvmProvider._extends(
              {
                injected: true,
              },
        ...
        if (chain === 'SUI' && !providers.tomo_sui) {
          var _providers3 = new tomoWalletTgSdkV2.default(
            tomoEvmProvider._extends(
              {
                injected: true,
              },
      ...
      if (connectType === 'TOMO') {
        ...
        (_providers$ethereum = providers.ethereum) == null ||
          _providers$ethereum.on(
            tomoEvmProvider.TomoProviderEventName
              .TOMO_EVM_PROVIDER_DISCONNECTED,
            disconnectEffect
          );
        return function () {
...
function _getUXUYProvider() {
  _getUXUYProvider = tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
      .mark(function _callee4(_ref) {
          ...
          while (1)
            switch ((_context4.prev = _context4.next)) {
              ...
              case 3:
                _context4.next = 5;
                return new Promise(function (resolve) {
                  resolve(_interopNamespace(require('@uxuycom/web3-tg-sdk')));
                });
              case 5:
...
function _disconnectAll() {
  _disconnectAll = tomoEvmProvider._asyncToGenerator(
    /*#__PURE__*/ tomoEvmProvider
      ._regeneratorRuntime()
      .mark(function _callee5(providers) {
...
var ICON_MAP =
  ((_ICON_MAP = {}),
  (_ICON_MAP[tomoEvmProvider.CONNECT_MAP.OKX_CONNECT] = SvgOkxWallet),
  (_ICON_MAP[tomoEvmProvider.CONNECT_MAP.TON_CONNECT] = TON_ICON),
  (_ICON_MAP[tomoEvmProvider.CONNECT_MAP.TOMO_MINI_APP] = SvgTomo),
  (_ICON_MAP[tomoEvmProvider.CONNECT_MAP.BITGET_WALLET] = function () {
  ...
  (_ICON_MAP[tomoEvmProvider.CONNECT_MAP.UXUY_WALLET] = function () {
    return React__default.createElement(
      'div',
      {
        style: {
...
var ConnectMain = function ConnectMain(_ref) {
  ...
  var connectOptionList = React.useMemo(
    function () {
      if (supportedConnects.length) {
        return Array.from(
          new Set(
            [tomoEvmProvider.CONNECT_MAP.TOMO_MINI_APP].concat(
              supportedConnects
            )
          )
        );
      ...
      var list = connectedInHistory
        ? tomoEvmProvider.ChainIdWithConnectsMap[chain] || []
        : [tomoEvmProvider.CONNECT_MAP.TOMO_MINI_APP];
      return list;
    },
    [chain, supportedConnects]
  );
  var connected = React.useMemo(
    function () {
      return (
        okxEVMConnected ||
        okxTonConnected ||
            ...
            while (1)
              switch ((_context.prev = _context.next)) {
                ...
                case 2:
                  _context.t0 = wallet;
                  _context.next =
                    _context.t0 === tomoEvmProvider.CONNECT_MAP.OKX_CONNECT
                      ? 5
                      : _context.t0 === tomoEvmProvider.CONNECT_MAP.TON_CONNECT
                        ? 10
                        : _context.t0 ===
                            tomoEvmProvider.CONNECT_MAP.TOMO_MINI_APP
                          ? 38
                          : _context.t0 ===
                              tomoEvmProvider.CONNECT_MAP.BITGET_WALLET
                            ? 43
                            : _context.t0 ===
                                tomoEvmProvider.CONNECT_MAP.UXUY_WALLET
                              ? 47
                              : 51;
                  break;
                case 5:
                ...
                case 14:
                  ...
                  _context.next = 17;
                  return new Promise(function (resolve) {
                    resolve(require('./TonConnect-dedc23e0.js'));
                  });
                case 17:
                ...
                case 23:
                  ...
                  _context.next = 26;
                  return new Promise(function (resolve) {
                    resolve(require('./index-9bc5e99b.js'));
                  });
                case 26:
            ...
            while (1)
              switch ((_context3.prev = _context3.next)) {
                ...
                case 12:
                  _context3.next = 14;
                  return tomConnect(
                    tomoEvmProvider._extends({}, connectOptions, {
                      email: email,
                    })
                  );
                case 14:
  ...
  React.useEffect(
    function () {
      ...
      setShowConnectors(!isFocus || tomoEvmProvider.isPcBrowser());
    },
    [isFocus]
  );
  React.useEffect(function () {
    // detect if is IOS
    setIsIOS(tomoEvmProvider.isIOS());
  }, []);
  return React__default.createElement(
    'div',
    {
    ...
    React__default.createElement(
      ...
      React__default.createElement('input', {
        ...
        onChange: (function () {
          var _onChange = tomoEvmProvider._asyncToGenerator(
            /*#__PURE__*/ tomoEvmProvider
              ._regeneratorRuntime()
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          connectOptionList.map(function (option) {
            ...
            var displayName = tomoEvmProvider.getDisplayName(option);
            var displayDesc = tomoEvmProvider.getDisplayDescription(option);
            return React__default.createElement(
              'div',
              {
                key: option,
    ...
    React__default.createElement('div', {
      ...
      className: cn({
        ...
        'tm-hidden': !(isIOS && !showConnectors),
      }),
      style: {
        height: 80,
      },
...
var isSafeAtom = /*#__PURE__*/ jotai.atom(false);
...
function useIphoneFocusFix(keepScrolling) {
  var isSafe = jotai.useAtomValue(isSafeAtom);
  React.useEffect(
    function () {
      if (!isIPhone()) {
        return function () {};
...
var TomoModal = function TomoModal(_ref) {
  ...
  var _useState3 = React.useState(!!back),
    isShowBack = _useState3[0],
    setIsShowBack = _useState3[1];
  var _useState4 = React.useState(title),
      ...
      qrCode &&
        React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(qrcode_react.QRCodeSVG, {
              value: qrCode,
            })
          ),
          React__default.createElement(
...
var TomoContext = /*#__PURE__*/ React.createContext(undefined);
...
var TomoProvider = function TomoProvider(_ref) {
  ...
  React.useEffect(
    function () {
      tomoEvmProvider.api.init(endpoints, tmaid, tmakey);
    },
  ...
  var onLogin = React.useCallback(
    /*#__PURE__*/ (function () {
      var _ref2 = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
          .mark(function _callee(type, open) {
            var c, res;
            return tomoEvmProvider._regeneratorRuntime().wrap(
              function _callee$(_context) {
                while (1)
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 10:
                      _context.next = 12;
                      return tomoEvmProvider.loginApi('' + initData);
                    case 12:
                      res = _context.sent;
                      setUserInfo(res);
                      if (
  ...
  var onSendEmailCode = React.useCallback(
    /*#__PURE__*/ (function () {
      var _ref4 = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
              ...
              .wrap(function _callee3$(_context3) {
                while (1)
                  switch ((_context3.prev = _context3.next)) {
                    case 0:
                      _context3.next = 2;
                      return tomoEvmProvider.sendBindEmailCodeApi(params);
                    case 2:
                      return _context3.abrupt('return', _context3.sent);
                    case 3:
                    case 'end':
  ...
  var onVerifyEmailCode = React.useCallback(
    /*#__PURE__*/ (function () {
      var _ref5 = tomoEvmProvider._asyncToGenerator(
        /*#__PURE__*/ tomoEvmProvider
          ._regeneratorRuntime()
                ...
                while (1)
                  switch ((_context4.prev = _context4.next)) {
                    ...
                    case 4:
                      ...
                      _context4.next = 7;
                      return tomoEvmProvider.verifyBindEmailCodeApi(params);
                    case 7:
  ...
  var onUpdateUserInfo = React.useCallback(
    /*#__PURE__*/ tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee5() {
          ...
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee5$(
            ...
            while (1)
              switch ((_context5.prev = _context5.next)) {
                case 0:
                  _context5.next = 2;
                  return tomoEvmProvider.getTelegramUserInfoApi();
                case 2:
                  res = _context5.sent;
                  setUserInfo(
                    tomoEvmProvider._extends({}, userInfo, res.result)
                  );
  ...
  var openConnectModal = React.useCallback(function (options) {
    setConnectOptions(options);
    setOpened(true);
  }, []);
  var closeConnectModal = React.useCallback(function () {
    setOpened(false);
  }, []);
  // evm connection
  // useEffect(() => {
  ...
  //   }
  // }, [providers.ethereum]);
  var tomoProviderValue = React.useMemo(
    function () {
      return tomoEvmProvider._extends(
        {
          tmaid: tmaid,
          tmakey: tmakey,
          env: env,
          ...
          apiList: tomoEvmProvider.apiList,
...
var useTomo = function useTomo() {
  var context = React.useContext(TomoContext);
                ...
                while (1)
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 3:
                      _context.prev = 3;
                      _context.next = 6;
                      return tomoEvmProvider.buildSwapTxApi(params);
                    case 6:
                      return _context.abrupt('return', _context.sent);
                    case 9:
                      _context.prev = 9;
...
var useOTC = function useOTC() {
  ...
  var showRamp = function showRamp(token) {
    ...
    var RampModal = new rampInstantSdk.RampInstantSDK({
...
function useOnRamp(_ref) {
  ...
  var chain = chains.find(function (c) {
    ...
    if (chain_id == tomoEvmProvider.mockSolEvmChainId) {
...
var useTonTransactions = function useTonTransactions() {
  var queryHash = /*#__PURE__*/ (function () {
    var _ref = tomoEvmProvider._asyncToGenerator(
      /*#__PURE__*/ tomoEvmProvider
        ._regeneratorRuntime()
        .mark(function _callee(address, msgHash) {
          var res, item;
          return tomoEvmProvider._regeneratorRuntime().wrap(function _callee$(
            _context
          ) {
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                  return tomoEvmProvider.getTransactionsByInMessageHash(
                    msgHash
                  );
                case 2:
                  res = _context.sent;
                  ...
                  item = res.find(function (item) {
                    var walletAddress = core.Address.parse(
                      item.account
                    ).toString({
                      bounceable: false,
                    });
...
function Seamless(_ref) {
  var onConnect = _ref.onConnect,
    ...
    restProps = tomoEvmProvider._objectWithoutPropertiesLoose(_ref, _excluded);
  var _useThemeParams = reactTelegramWebApp.useThemeParams(),
...
function initTomoModal(_ref3) {
  var _ref3$onConnect = _ref3.onConnect,
    ...
    restProps = tomoEvmProvider._objectWithoutPropertiesLoose(
      _ref3,
      _excluded2
    );
...
exports.AddressString = tomoEvmProvider.AddressString;
exports.BigIntString = tomoEvmProvider.BigIntString;
Object.defineProperty(exports, 'CONNECT_MAP', {
  enumerable: true,
  get: function () {
    return tomoEvmProvider.CONNECT_MAP;
  },
});
exports.HexString = tomoEvmProvider.HexString;
exports.IntNumber = tomoEvmProvider.IntNumber;
exports.OpaqueType = tomoEvmProvider.OpaqueType;
exports.PROVIDER_ALLIANCE = tomoEvmProvider.PROVIDER_ALLIANCE;
exports.RegExpString = tomoEvmProvider.RegExpString;
Object.defineProperty(exports, 'TomoProviderEventName', {
  enumerable: true,
  get: function () {
    return tomoEvmProvider.TomoProviderEventName;
  },
});
Object.defineProperty(exports, 'TonTxBodyType', {
  enumerable: true,
  get: function () {
    return tomoEvmProvider.TonTxBodyType;
  },
});
exports.api = tomoEvmProvider.api;
exports.mockEvmChainIds = tomoEvmProvider.mockEvmChainIds;
exports.signEvmTransactionApi = tomoEvmProvider.signEvmTransactionApi;
exports.useLocalStore = tomoEvmProvider.useLocalStore;
exports.TomoWalletTgSdkV2 = tomoWalletTgSdkV2.default;
exports.Dummy = Dummy;
exports.Seamless = Seamless;
exports.TomoContext = TomoContext;
exports.TomoProvider = TomoProvider;
exports.defaultEndpoints = defaultEndpoints;
exports.defaultTMAuthLink = defaultTMAuthLink;
exports.initTomoModal = initTomoModal;
exports.useBalance = useBalance;
exports.useBiometricManager = useBiometricManager;
exports.useBuildSwapTx = useBuildSwapTx;
exports.useChains = useChains;
exports.useConfig = useConfig;
exports.useMFAVerify = useMFAVerify;
exports.useOnRamp = useOnRamp;
exports.usePaymentPasswd = usePaymentPasswd;
exports.useSendTransaction = useSendTransaction;
exports.useStore = useStore;
exports.useSwapTokens = useSwapTokens;
exports.useTomo = useTomo;
exports.useTomoUserInfo = useTomoUserInfo;
exports.useTonTransactions = useTonTransactions;
exports.useTransactions = useTransactions;
exports.useUserTokens = useUserTokens;
//# sourceMappingURL=tomo-telegram-sdk.cjs.development.js.map
